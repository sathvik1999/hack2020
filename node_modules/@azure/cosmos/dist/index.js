(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('os-name'), require('tslib'), require('crypto'), require('debug'), require('priorityqueuejs'), require('semaphore'), require('fast-json-stable-stringify'), require('uuid'), require('node-abort-controller'), require('node-fetch')) :
    typeof define === 'function' && define.amd ? define(['exports', 'os-name', 'tslib', 'crypto', 'debug', 'priorityqueuejs', 'semaphore', 'fast-json-stable-stringify', 'uuid', 'node-abort-controller', 'node-fetch'], factory) :
