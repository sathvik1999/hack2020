...
declare type AggregateType = "Average" | "Count" | "Max" | "Min" | "Sum";
...
declare interface ContainerRequest extends VerboseOmit<ContainerDefinition, "partitionKey"> {
    throughput?: number;
...
declare interface GroupByAliasToAggregateType {
    [key: string]: AggregateType;
}

declare type GroupByExpressions = string[];
...
declare type SubStatusCode = typeof SubStatusCode[keyof typeof SubStatusCode];
